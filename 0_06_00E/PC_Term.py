            ...
            if option.lower( )== ("y"):
                ...
                for dept in dept_tobacco_id:
                    ...
                    with open(file_idchk) as xmlin:
                        ...
                        #print (soup)
                        #os.system("pause")
                        for department in soup('department', string='0011'):
                            # we should check if we still have idChecks in the list before popping
                            id_check = '<idChecks><domain:idCheck sysid="1"/></idChecks>'
                            department.find_parent('PLU').append(id_check)
